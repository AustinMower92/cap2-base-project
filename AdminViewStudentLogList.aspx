<%@ Page Title="" Language="C#" MasterPageFile="~/Admin-Master.Master" AutoEventWireup="true" CodeBehind="AdminViewStudentLogList.aspx.cs" Inherits="Capstone_1_Monthly_Evaluation.AdminViewStudentLogList" %>
                ...
                <div class="container">
                    <asp:GridView ID="gvLogs2" runat="server" AutoGenerateColumns="False" RowStyle-BackColor="#FFFBED" RowStyle-BorderStyle="NotSet" CssClass="table" AllowPaging="True" EmptyDataText="No data available" PageSize="2" OnPageIndexChanging="gvLogs2_PageIndexChanging" OnSelectedIndexChanged="gvLogs2_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField HeaderText="View" NavigateUrl="AdminViewStudentLog.aspx" Text="View" HeaderStyle-Font-Size="X-Large" HeaderStyle-BackColor="#9D2235" HeaderStyle-ForeColor="White">
